...
class CreateUpdateBookRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'num_pages' => 'required|numeric|min:1|max:5000',
    ...
    public function messages(): array
    {
        return [
            ...
            'size.numeric' => "Trọng lượng phải là kiểu số!",
            'size.max' => "Kích thước tối đa :max ký tự!",
            ...
            'weight.min' => "Trọng lượng Không được bé hơn 1",
            ...
            'num_pages.min' => "Trọng lượng Không được bé hơn 1",
