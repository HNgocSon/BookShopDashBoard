...
Route::get('/accept/{customer}/{token}', [APICustomerController::class, 'Accept'])->name('customer.accept');

Route::get('thong-bao}',[APICustomerController::class,'ThongBao'])->name('thong-bao');
